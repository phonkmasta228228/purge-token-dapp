...
export const ClaimRank: FC = () => {
  ...
  return (
    <div className="max-w-xl mx-auto px-4 py-10">
      ...
      <div className="mt-6 bg-[#0d1a0d] border border-[#00FFAA33] rounded p-4 text-xs text-[#00FFAA] space-y-1">
      ...
      <div className="mt-4 bg-[#111] border border-[#1a1a1a] rounded p-4 text-xs text-[#444] space-y-1">
